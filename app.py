...
st.sidebar.markdown("""
    ...
    <a href="/?page=AboutUs" class="sidebar-link" target="_self">📊 About Us</a>
    <a href="/?page=Model Visualisations" class="sidebar-link" target="_self">📈 Model Visualisations</a>
    """, unsafe_allow_html=True)
